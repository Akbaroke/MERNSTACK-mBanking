...
import { cekNomerRekening, getListBankLain, TambahNorekAntarBank, TambahNorekAntarRekening, Transfer } from '../controllers/Transfer.js';
...
router.get('/list_banklain', verifyToken, getListBankLain);
