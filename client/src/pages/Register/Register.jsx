...
function Register() {
  ...
  const register = async () => {
    try {
      ...
      clearInput();
      setMsg(
        "Selamat, pendaftaran akun anda telah berhasil. Sekarang anda dapat menggunakan BAC mobile bangking dengan masuk ke menu m-BAC dan memasukan kode akses yang telah di daftarkan dengan perangkat ini."
      );
      setPopup("sukses");
    } catch (error) {
      clearInput();
    ...
    return (
      <>
        <div className="topbar-send">
          <div
            ...
            style={{
              position: "absolute",
              left: 20,
              background: "linear-gradient(to bottom, #B2B2B2, #5E5E5E)",
            }}
          >
            Close
          </div>
          ...
          <div>
            ...
            <div
              className="send"
              style={{ visibility: otp.length === 4 ? "visible" : "hidden" }}
              onClick={() => {
                setPopup("loading");
                OtpAuth();
              }}
        ...
        <div className="verifikasi-otp">
          ...
          <p>
            Demi keamanan Anda, silakan masukkan kode OTP yang telah kami
            kirimkan ke email Anda untuk verifikasi Registrasi BCA mobile.
          </p>
          <p>{hideEmail(email)}</p>
          <div>
            <input
              ...
              style={{
                border: pin1 !== "" ? "2px solid #013682" : "2px solid #B0B0B0",
              }}
            />
            <input
              ref={pin2Ref}
              ...
              style={{
                border: pin2 !== "" ? "2px solid #013682" : "2px solid #B0B0B0",
              }}
            />
            <input
              ref={pin3Ref}
              ...
              style={{
                border: pin3 !== "" ? "2px solid #013682" : "2px solid #B0B0B0",
              }}
            />
            <input
              ref={pin4Ref}
              ...
              style={{
                border: pin4 !== "" ? "2px solid #013682" : "2px solid #B0B0B0",
              }}
            />
          </div>
          ...
          {limitResendCode <= 0 ? (
            <p
              ...
              onClick={() =>
                limitResendCode <= 0 ? sendReqOtp() : console.log("Error")
              }
            >
              Kirim Kode OTP
            </p>
